...
```{r}
ggplot(training_mae_testing_mean) + geom_point(aes(x=mae_mean, y=mean_training, color=Parameters), alpha=0.2) +  scale_x_continuous(trans='log10') + scale_y_continuous(trans='log10') + geom_errorbar(aes(x=mae, y=training_time, color=Parameters), stat = "summary", fun.data = "mean_sdl", fun.args = list(mult = 1))
