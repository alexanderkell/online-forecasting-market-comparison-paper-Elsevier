...
ggplot(offline_rf_actual_predicted) + geom_line(aes(x=hour, colour=variable, y=value)) + theme_classic() + theme(text = element_text(size=40), legend.position = "bottom", plot.margin=grid::unit(c(0,0,0,0), "mm"))```
