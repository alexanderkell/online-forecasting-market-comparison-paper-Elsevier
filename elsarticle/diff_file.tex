...
%DIF DEL submitted-elsarticle-template-harv.tex   Tue Sep  1 14:11:40 2020
%DIF ADD elsarticle-template-harv.tex             Tue Sep  1 14:07:09 2020
...
\DIFdelbegin \DIFdel{However, it }\DIFdelend \DIFaddbegin \DIFadd{It }\DIFaddend should be noted, that such a-priori \DIFdelbegin \DIFdel{intuiton}\DIFdelend \DIFaddbegin \DIFadd{intuition}\DIFaddend , is no substitute for analytical evidence and can (and has) been shown to be wrong in the past, due to imperfect knowledge of the data and understanding of some of the black box models, such as neural networks.
...
\begin{enumerate}
  \item The evaluation of different online and offline learning models to forecast the electricity demand profile 24 hours ahead. \DIFaddbegin \DIFadd{This work extends previous work by utilizing a vast array of different online and offline techniques.
  }\DIFaddend \item Evaluation of poor predictive ability on the long-term electricity market in the UK through the perturbation of demand in the \DIFaddbegin \DIFadd{novel }\DIFaddend ElecSim simulation. \DIFaddbegin \DIFadd{There remains a gap in the literature of the long-term impact of poor electricity demand predictions on the electricity market.
...
\DIFaddbegin \DIFadd{ElecSim has previously been validated in \mbox{%DIFAUXCMD
\cite{Kell2020}}\hspace{0pt}%DIFAUXCMD
...
\DIFaddbegin \DIFadd{Table \ref{table:offline_ml_metrics} displays different metrics for measuring the accuracy of the offline machine learning techniques. These include Mean Squared Error (MSE), Root Mean Squared Error (RMSE), Mean Absolute Error (MAE) and the Mean R-Squared. The results largely compliment each other. With high error values in one metric correlating to high error metrics in others for each of the estimators.
}
...
\footnotesize
	\begin{tabular}{@{}lllllll@{}}
		\toprule
		\DIFaddFL{Estimator                 }& \DIFaddFL{Mean Fit Time }& \DIFaddFL{Mean Score Time }& \DIFaddFL{Mean MSE    }& \DIFaddFL{Mean RMSE }& \DIFaddFL{Mean MAE }& \DIFaddFL{Mean R-Squared }\\ \midrule
		\DIFaddFL{LinearRegression          }& \DIFaddFL{57            }& \DIFaddFL{4.84            }& \DIFaddFL{9444808.95  }& \DIFaddFL{3073.24   }& \DIFaddFL{2249.34  }& \DIFaddFL{0.81           }\\
		\DIFaddFL{Lasso                     }& \DIFaddFL{787.97        }& \DIFaddFL{3.13            }& \DIFaddFL{9446957.22  }& \DIFaddFL{3073.59   }& \DIFaddFL{2249.55  }& \DIFaddFL{0.81           }\\
		\DIFaddFL{Ridge                     }& \DIFaddFL{26.99         }& \DIFaddFL{5.03            }& \DIFaddFL{9444701.58  }& \DIFaddFL{3073.22   }& \DIFaddFL{2252.23  }& \DIFaddFL{0.81           }\\
		\DIFaddFL{ElasticNet                }& \DIFaddFL{54.49         }& \DIFaddFL{6.13            }& \DIFaddFL{31139231.96 }& \DIFaddFL{5580.25   }& \DIFaddFL{4628.64  }& \DIFaddFL{0.36           }\\
		\DIFaddFL{llars                     }& \DIFaddFL{46.85         }& \DIFaddFL{8               }& \DIFaddFL{10164815.45 }& \DIFaddFL{3188.23   }& \DIFaddFL{2333.31  }& \DIFaddFL{0.79           }\\
		\DIFaddFL{ExtraTreesRegressor       }& \DIFaddFL{9321.52       }& \DIFaddFL{58.06           }& \DIFaddFL{5562579.53  }& \DIFaddFL{2358.51   }& \DIFaddFL{1605     }& \DIFaddFL{0.89           }\\
		\DIFaddFL{RandomForestRegressor     }& \DIFaddFL{16567.46      }& \DIFaddFL{13.99           }& \DIFaddFL{5882618.89  }& \DIFaddFL{2425.41   }& \DIFaddFL{1646.29  }& \DIFaddFL{0.88           }\\
		\DIFaddFL{AdaBoostRegressor         }& \DIFaddFL{8897.55       }& \DIFaddFL{26.9            }& \DIFaddFL{18551963.36 }& \DIFaddFL{4307.2    }& \DIFaddFL{3544.49  }& \DIFaddFL{0.62           }\\
		\DIFaddFL{GradientBoostingRegressor }& \DIFaddFL{6417.62       }& \DIFaddFL{8.16            }& \DIFaddFL{6744402.87  }& \DIFaddFL{2597      }& \DIFaddFL{1833.62  }& \DIFaddFL{0.86           }\\
		\DIFaddFL{SVR                       }& \DIFaddFL{19170.82      }& \DIFaddFL{5221.66         }& \DIFaddFL{51217167.5  }& \DIFaddFL{7156.62   }& \DIFaddFL{5926.75  }& \DIFaddFL{-0.05          }\\
		\DIFaddFL{KNeighborsRegressor       }& \DIFaddFL{118.89        }& \DIFaddFL{15215.87        }& \DIFaddFL{10107201.23 }& \DIFaddFL{3179.18   }& \DIFaddFL{2246.6   }& \DIFaddFL{0.79           }\\ \bottomrule
	\end{tabular}
\caption{\DIFaddFL{Different metrics for offline machine learning results.}}
...
\DIFaddbegin \DIFadd{Table \ref{table:online_ml_metrics} displays the metrics for each of the online methods. This includes the mean MSE, mean RMSE and mean MAE. Again, the metrics largely correlate with each other.
}
...
%DIF > \begin{table*}[]
%DIF > 	\footnotesize
%DIF > 	\begin{tabular}{p{6.5cm}lllll@{}}
%DIF > 		\toprule
%DIF > 		Estimator                                                                          & Mean Fit Time & Mean Score Time & Mean MSE     & Mean RMSE & Mean MAE \\ \midrule
%DIF > 		
%DIF > 		(PA) C = 0.1, fit intercept = false & 173.52        & 24.63           & 103015609.55 & 9497.47   & 5888.4   \\
%DIF > 		(PA) C = 0.1, fit intercept = true     & 168.66        & 24.07           & 63201775.28  & 7430.63   & 4605.94  \\
%DIF > 		(PA) C = 2, fit intercept = false      & 165.23        & 23.75           & 7451087.49   & 2723.25   & 1927.33  \\
%DIF > 		(PA) C = 2, fit intercept = true    & 174.33        & 24.63           & 7223163.14   & 2681.2    & 1907.59  \\
%DIF > 		Linear Regression                                                                  & 174.91        & 24.65           & 7223163.14   & 2681.2    & 1907.59  \\
%DIF > 		(MLP) hidden layer sizes = 10, learning rate = adaptive                                  & 71.36         & 6.58            & 9612351.37   & 3076.77   & 2221.48  \\
%DIF > 		(Box Cox) power = 0.1                                                              & 38.61         & 4.88            & 2921934.52   & 1703.79   & 1214.95  \\\bottomrule
%DIF > 	\end{tabular}
%DIF > 	\caption{Different metrics for online machine learning results.}
%DIF > 	\label{table:online_ml_metrics}
%DIF > \end{table*}
...
\toprule
\DIFaddFL{Estimator                                                                          }& \DIFaddFL{Mean Fit Time }& \DIFaddFL{Mean Score Time }& \DIFaddFL{Mean MSE     }& \DIFaddFL{Mean RMSE }& \DIFaddFL{Mean MAE }\\ \midrule
\DIFaddFL{(PA) C = 0.1, fit intercept = false }& \DIFaddFL{173.52        }& \DIFaddFL{24.63           }& \DIFaddFL{103015609.55 }& \DIFaddFL{9497.47   }& \DIFaddFL{5888.4   }\\
\DIFaddFL{(PA) C = 0.1, fit intercept = true     }& \DIFaddFL{168.66        }& \DIFaddFL{24.07           }& \DIFaddFL{63201775.28  }& \DIFaddFL{7430.63   }& \DIFaddFL{4605.94  }\\
\DIFaddFL{(PA) C = 2, fit intercept = false      }& \DIFaddFL{165.23        }& \DIFaddFL{23.75           }& \DIFaddFL{7451087.49   }& \DIFaddFL{2723.25   }& \DIFaddFL{1927.33  }\\
\DIFaddFL{(PA) C = 2, fit intercept = true       }& \DIFaddFL{174.91        }& \DIFaddFL{24.65           }& \DIFaddFL{7223163.14   }& \DIFaddFL{2681.2    }& \DIFaddFL{1907.59  }\\
\DIFaddFL{(MLP) (all parameter variations)                                                     }& \DIFaddFL{71.36         }& \DIFaddFL{6.58            }& \DIFaddFL{9612351.37   }& \DIFaddFL{3076.77   }& \DIFaddFL{2221.48  }\\
\DIFaddFL{(Box Cox) power = 0.1                                                              }& \DIFaddFL{38.61         }& \DIFaddFL{4.88            }& \DIFaddFL{2921934.52   }& \DIFaddFL{1703.79   }& \DIFaddFL{1214.95  }\\
\DIFaddFL{Linear Regression                                                                  }& \DIFaddFL{38.61         }& \DIFaddFL{4.85            }& \DIFaddFL{5629651.14   }& \DIFaddFL{2368.3    }& \DIFaddFL{1785.02  }\\ \bottomrule
\end{tabular}
	\caption{\DIFaddFL{Different metrics for online machine learning results.}}
...
\DIFaddend Figure \ref{fig:best_online_learning_day_distribution} displays the best online model. We can see a significant improvement over the best online model distribution, shown in Figure \ref{fig:best_offline_learning_day_distribution}. We remain within the max tendered national grid reserve for 98.9\% of the time, and the average available tendered national grid reserve is close to the 5\% and 95\% percentiles.
...
\begin{figure}[h]
\centering
\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=\columnwidth,natwidth=500,natheight=300]{figures/results/online_learning_dists-C-0.1-fit_intercept-true-max_iter-1000-shuffle-false-tol 0.001.eps}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=\columnwidth,natwidth=500,natheight=400]{figures/results/online_learning_dists-C-0.1-fit_intercept-true-max_iter-1000-shuffle-false-tol 0.001.eps}
\DIFaddendFL \caption{Online machine learning algorithm distribution. (Passive Aggressive Regressor (C=0.1, fit intercept = true, maximum iterations = 1000, shuffle = false, tolerance = 0.001), chosen as it was the worst result for the passive aggressive model.}
...
\DIFadd{In this Section we run a sensitivity analysis to visualise the effects of different errors on the average electricity mix over the 2018 to 2035 time period. To conduct this sensitivity analysis, we used a normal distribution with a mean of 0 and modified the standard deviation between 1,000 and 20,000, in increments of 1,000. We selected the normal distribution due to its observation in nature, and its symmetric properties. We chose to increase the standard deviation until 20,000 due to it being 33\% larger than the errors shown in the previous subsection. This gave us a larger error than had previously been explored.
}
...
\begin{figure}[h]
\centering
\includegraphics[width=\columnwidth,natwidth=800, natheight=600]{figures/results/sensitivity_analysis.pdf}
\caption{\DIFaddFL{Sensitivity analysis of changing demand prediction error using a normal distribution and varying the standard deviation vs. mean contributed energy per type between 2018 and 2035.}}
\label{fig:sensitivity-analysis}
\end{figure}

\DIFadd{Figure \ref{fig:sensitivity-analysis} displays the results of this sensitivity analysis. At all standard deviations, photovoltaics displays the highest contributed energy, CCGT the second most and Nuclear the third most. Coal, onshore and the others contribute a smaller amount of energy than the top three.
}

\DIFadd{Whilst photovoltaics remains high throughout, it reduces up until a standard deviation of 14,000MW, after which it begins to increase. This reduction up until 14,000MW may be due to the fact that the predicted demand changes so quickly, that photovoltaics are unable to be reliably dispatched on the day-ahead market to meet this changing predicted demand. Nuclear is, however, able to fill the demand that photovoltaics can not, due to its dispatchable nature.
}

\DIFadd{After a standard deviation of 14,000MW, photovoltaics increases, whilst nuclear decreases. This may be due to the large positive error predictions, which photovoltaics believes it is able to be dispatched on and displaces the more expensive nuclear energy technology.
}
