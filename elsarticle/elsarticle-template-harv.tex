...
\begin{figure}
\centering
    \includegraphics[width=0.3\textwidth]{figures/methods/Kell_eEnergy_Fig1.eps}
...
\begin{figure}
\centering
\includegraphics[width=0.6\columnwidth]{figures/results/elecsim_results/results_2/Carbon_emitted_mean_output.eps}
\caption{Mean carbon emissions between 2018 and 2035.}
\label{fig:Carbon_emitted_mean_output}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.7\columnwidth,natwidth=800, natheight=550]{figures/results/sensitivity_analysis.pdf}
