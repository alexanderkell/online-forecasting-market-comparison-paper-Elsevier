...
\begin{figure}
\centering
\includegraphics[width=\columnwidth]{figures/results/offline_mae_plot.eps}
\caption{Offline machine learning mean absolute errror comparson, with 95\% confidence interval for 5 runs of each model.}
...
\caption{Best offline machine learning learning algorithm (Random Forest) predictions versus actuals for a single day.}
