...
\begin{figure*}
%\centering
\includegraphics[width=0.8\textwidth,natwidth=1000,natheight=1000]{figures/results/online_model_mae_barplot.eps}
...
\begin{figure}
\centering
\includegraphics[width=\columnwidth,natwidth=1100,natheight=700]{figures/results/both_actual_predicted.eps}
\caption{Actual demand versus predicted for random forest and box cox regressor (offline and online resectively) for the dates of 10th to the 17th June 2018.}
...
%online_learning_dists-PA-regressor-C-2-fit_intercept-false-max_iter-1000-shuffle-false-tol-0.001.eps
