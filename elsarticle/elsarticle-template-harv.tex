...
K-Neighbors regression is a non-parametric method used for regression. The input consists of a new data point and the algorithm finds the \textit{k} closest training examples in the feature space. The output is the average value of the \textit{k} nearest neighbours.
