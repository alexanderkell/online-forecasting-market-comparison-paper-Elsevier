...
Figure \ref{fig:best_online_learning_day_distribution} displays the comparison of mean absolute errors for the different trialled online regressor models. To produce this graph, we showed the various hyperparameter trials. Where the hyperparameters had the same results we removed them. For the multilayer perceptron (MLP), we aggregated all hyperparameters, due to the similar nature of the predictions.
