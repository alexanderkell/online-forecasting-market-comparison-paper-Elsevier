...
However, it must be noted, that it can be difficult to have an intuition, a-priori, about which model will work best, due to imperfect knowledge of the data and understanding of some of the black box models, such as neural networks.
...
\begin{figure}
\centering
    \includegraphics[width=0.4\textwidth]{Kell_eEnergy_Fig1.eps}
...
\begin{figure}
    \includegraphics[width=0.48\textwidth,natwidth=610,natheight=400]{System_overview_large.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=\columnwidth,natwidth=500,natheight=500]{offline_model_mae.eps}
...
\begin{figure}
\centering
\includegraphics[width=\columnwidth,natwidth=500,natheight=500]{ExtraTreesRegressor_distribution_plot.eps}
...
\begin{figure}[h]
\centering
\includegraphics[width=\columnwidth,natwidth=1300,natheight=1300]{online_model_mae_barplot.eps}
...
\begin{figure}
\centering
\includegraphics[width=\columnwidth,natwidth=500,natheight=500]{online_learning_dists-power-0.1.eps}
...
\begin{figure}[h]
\centering
\includegraphics[width=\columnwidth,natwidth=500,natheight=500]{online_learning_dists-passive.eps}
