...
\begin{figure}
    \includegraphics[width=0.48\textwidth]{System_overview_large.png}
...
%\begin{figure}[h]
%\centering
%\includegraphics[width=\columnwidth]{offline_fit_time_vs_mae_all_results.eps}
...
\begin{figure}[h]
\centering
\includegraphics[width=\columnwidth]{offline_score_time_vs_mae_all_results.eps}
...
\begin{figure}
\centering
\includegraphics[width=\columnwidth]{online_learning_dists-power-01.eps}
...
\begin{figure}[h]
\centering
\includegraphics[width=\columnwidth]{online_learning_dists-passive.eps}
